...
const pool = new Pool({
  user: 'postgres',
  host: 'localhost',
  database: 'music2', // Se creó la base de datos llamada music2
  password: '123456',
  port: 5433,
});
...
const getAlumno = async () => {
  try {
    // Usar un objeto para la consulta
    const query = {
...
const ejecutar = async () => {
  try {
    ...
    // Capturar y mostrar cualquier error al ejecutar la función principal
